...
public:
	...
	///
	/// @param[in] centre Position of the centre of the cube
	/// @param[in] cubeWidth Width of the cube
	/// @param[in] cubeHeight Height of the cube
	/// @param[in] cubeLength Length of the cube
	//////////////////////////////////
